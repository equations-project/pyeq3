...
class Test_LegendrePolynomial2D(unittest.TestCase):
    ...
    def test_SecondDegreeLegendrePolynomial(self):
        equation = pyeq3.Models_2D.LegendrePolynomial.SecondDegreeLegendrePolynomial('SSQABS')
        pyeq3.dataConvertorService().ConvertAndSortColumnarASCII(equation.exampleData, equation, False)
...
class Test_Polyfunctional2D(unittest.TestCase):
    ...
    def test_Polyfunctional2D(self):
        equation = pyeq3.Models_2D.Polyfunctional.UserSelectablePolyfunctional('SSQABS', 'Default', [0,1,3])
        pyeq3.dataConvertorService().ConvertAndSortColumnarASCII(equation.exampleData, equation, False)
...
class Test_Polyfunctional3D(unittest.TestCase):
    ...
    def test_Polyfunctional3D(self):
        equation = pyeq3.Models_3D.Polyfunctional.UserSelectablePolyfunctional('SSQREL', 'Default', [[0,0], [1,1], [3,3]])
        pyeq3.dataConvertorService().ConvertAndSortColumnarASCII(equation.exampleData, equation, False)
...
class Test_Rationals(unittest.TestCase):
    ...
    def test_Rational2D(self):
        equation = pyeq3.Models_2D.Rational.UserSelectableRational('SSQABS', 'Default', [0,1], [2,3])
        pyeq3.dataConvertorService().ConvertAndSortColumnarASCII(equation.exampleData, equation, False)
        self.assertTrue(0.009 >= equation.CalculateAllDataFittingTarget(equation.Solve()))


    def test_Rational_WithOffset_2D(self):
        equation = pyeq3.Models_2D.Rational.UserSelectableRational('SSQABS', 'Offset', [0,1], [2,3])
        pyeq3.dataConvertorService().ConvertAndSortColumnarASCII(equation.exampleData, equation, False)
...
class Test_Polynomials(unittest.TestCase):
    ...
    def test_Polynomial3D(self):
        equation = pyeq3.Models_3D.Polynomial.UserSelectablePolynomial('SSQABS', 'Default', 2, 2)
        pyeq3.dataConvertorService().ConvertAndSortColumnarASCII(equation.exampleData, equation, False)
    ...
    def test_UserCustomizablePolynomial2D(self):
        flags = [8,9, 10]
        equation = pyeq3.Models_2D.Polynomial.UserCustomizablePolynomial('SSQABS', inPolynomial2DFlags=flags) # SSQABS by default
        pyeq3.dataConvertorService().ConvertAndSortColumnarASCII(equation.exampleData, equation, False)
        self.assertTrue(0.015 >= equation.CalculateAllDataFittingTarget(equation.Solve()))
