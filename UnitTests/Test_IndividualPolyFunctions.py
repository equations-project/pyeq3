...
class TestPolyFunctions(unittest.TestCase):
    ...
    def test_Power_NegativeOne_Term(self):
        term = pyeq3.PolyFunctions.PowerTerm('varName', 'codeName', powerString='-1.0', logFlag=False)
    ...
    def test_Power_OnePointFive_Term(self):
        term = pyeq3.PolyFunctions.PowerTerm('varName', 'codeName', powerString='1.5', logFlag=False)
    ...
    def test_Power_ZeroPointFive_Term(self):
        term = pyeq3.PolyFunctions.PowerTerm('varName', 'codeName', powerString='0.5', logFlag=False)
    ...
    def test_Power_Two_Term(self):
        term = pyeq3.PolyFunctions.PowerTerm('varName', 'codeName', powerString='2.0', logFlag=False)
    ...
    def test_Exponential_VariableUnchanged_Term(self):
        term = pyeq3.PolyFunctions.Exponential_VariableUnchanged_Term('varName', 'codeName')
    ...
    def test_Exponential_VariableTimesNegativeOne_Term(self):
        term = pyeq3.PolyFunctions.Exponential_VariableTimesNegativeOne_Term('varName', 'codeName')
    ...
    def test_Power_NegativeTwo_Term(self):
        term = pyeq3.PolyFunctions.PowerTerm('varName', 'codeName', powerString='-2', logFlag=False)
    ...
    def test_Power_NegativeOne_OfLog_Term(self):
        term = pyeq3.PolyFunctions.PowerTerm('varName', 'codeName', powerString='-1.0', logFlag=True)
    ...
    def test_Power_Two_OfLog_Term(self):
        term = pyeq3.PolyFunctions.PowerTerm('varName', 'codeName', powerString='2.0', logFlag=True)
