...
class TestExtendedVersionHandlers(unittest.TestCase):
    ...
    def test_ExtendedVersion_Reciprocal_Exponential_WithOffset_2D(self):
        equation = pyeq3.Models_2D.Exponential.Exponential('SSQABS', 'Reciprocal With Offset')
    ...
    def test_ExtendedVersion_Inverse_Exponential_WithOffset_2D(self):
        equation = pyeq3.Models_2D.Exponential.Exponential('SSQABS', 'Inverse With Offset')
    ...
    def test_ExtendedVersion_Exponential_WithLinearDecayAndOffset_2D(self):
        equation = pyeq3.Models_2D.Exponential.Exponential('SSQABS', 'Linear Decay And Offset')
    ...
    def test_ExtendedVersion_Exponential_WithLinearGrowthAndOffset_2D(self):
        equation = pyeq3.Models_2D.Exponential.Exponential('SSQABS', 'Linear Growth And Offset')
    ...
    def test_ExtendedVersion_Asymptotic_Exponential_A_WithExponentialGrowth_2D(self):
        equation = pyeq3.Models_2D.Exponential.AsymptoticExponentialA('SSQABS', 'Exponential Growth')
    ...
    def test_ExtendedVersion_Asymptotic_Exponential_A_WithExponentialGrowthAndOffset_2D(self):
        equation = pyeq3.Models_2D.Exponential.AsymptoticExponentialA('SSQABS', 'Exponential Growth And Offset')
    ...
    def test_ExtendedVersion_Asymptotic_Exponential_A_WithExponentialDecay_2D(self):
        equation = pyeq3.Models_2D.Exponential.AsymptoticExponentialA('SSQABS', 'Exponential Decay')
    ...
    def test_ExtendedVersion_Asymptotic_Exponential_A_WithExponentialDecayAndOffset_2D(self):
        equation = pyeq3.Models_2D.Exponential.AsymptoticExponentialA('SSQABS', 'Exponential Decay And Offset')
